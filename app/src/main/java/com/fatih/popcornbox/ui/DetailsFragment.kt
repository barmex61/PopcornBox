...
import com.fatih.popcornbox.adapter.DetailsFragmentViewPagerAdapter
import com.fatih.popcornbox.adapter.PosterImageViewPagerAdapter
import com.fatih.popcornbox.databinding.FragmentDetailsBinding
...
import com.fatih.popcornbox.other.Constants.language
...
class DetailsFragment : Fragment(R.layout.fragment_details) {
    ...
    private fun observeLiveData() {
        ...
        viewModel.isItInFavorite.observe(viewLifecycleOwner){response->
            response?.let {
                if(it){
                    isItInFavorite=true
                    binding.likeButton.imageTintList= ColorStateList.valueOf(ContextCompat.getColor(requireContext(),R.color.scarletRed))
                }else{
                    resetFavorite()
                }
            }?:resetFavorite()
    ...
    private fun resetFavorite(){
        ...
        binding.likeButton.imageTintList= ColorStateList.valueOf(ContextCompat.getColor(requireContext(),R.color.white))
    }
